...
export const ui = {
  en: {
    ...
    poolHeading: 'Uploaded',
    poolListAria: 'Uploaded images',
    poolEmptyHint: 'All uploaded images are in the sequence.',
    sequenceHeading: 'Sequence',
    sequenceListAria: 'Rename sequence',
    sequenceEmptyHint: 'Add images from the left to build your rename sequence.',
    addToSequence: 'Add to sequence',
    addAllToSequence: 'Add all to sequence',
  ...
  ja: {
    ...
    poolHeading: 'アップロード済み',
    poolListAria: 'アップロード済みの画像',
    poolEmptyHint: 'アップロードした画像はすべてシーケンスに追加されています。',
    sequenceHeading: 'シーケンス',
    sequenceListAria: 'リネームの順序',
    sequenceEmptyHint: '左から画像を追加してシーケンスを作成してください。',
    addToSequence: 'シーケンスに追加',
    addAllToSequence: '全部シーケンスに追加',
    backToPool: 'プールに戻す',
    discardFile: '削除',
    moveUp: '上へ移動',
    moveDown: '下へ移動',
  ...
  zh: {
    ...
    poolHeading: '已上传',
    poolListAria: '已上传的图片',
    poolEmptyHint: '所有已上传的图片都已加入序列。',
    sequenceHeading: '序列',
    sequenceListAria: '重命名序列',
    sequenceEmptyHint: '从左侧添加图片以构建重命名序列。',
    addToSequence: '添加到序列',
    addAllToSequence: '全部添加到序列',
    backToPool: '返回待选',
    discardFile: '删除',
    moveUp: '上移',
    moveDown: '下移',
  ...
  de: {
    ...
    poolHeading: 'Hochgeladen',
    poolListAria: 'Hochgeladene Bilder',
    poolEmptyHint: 'Alle hochgeladenen Bilder befinden sich in der Sequenz.',
    sequenceHeading: 'Sequenz',
    sequenceListAria: 'Umbenennungsreihenfolge',
    sequenceEmptyHint: 'Füge Bilder von links hinzu, um deine Sequenz aufzubauen.',
    addToSequence: 'Zur Sequenz hinzufügen',
    addAllToSequence: 'Alle zur Sequenz hinzufügen',
    backToPool: 'Zurück in den Pool',
  ...
  es: {
    ...
    poolHeading: 'Subidas',
    poolListAria: 'Imágenes subidas',
    poolEmptyHint: 'Todas las imágenes subidas están en la secuencia.',
    sequenceHeading: 'Secuencia',
    sequenceListAria: 'Orden de renombrado',
    sequenceEmptyHint: 'Añade imágenes desde la izquierda para crear tu secuencia.',
    addToSequence: 'Añadir a la secuencia',
    addAllToSequence: 'Añadir todo a la secuencia',
    backToPool: 'Volver al grupo',
