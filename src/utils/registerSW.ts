...
export async function registerServiceWorker(): Promise<ServiceWorkerRegistration | null> {
  ...
  try {
    // Service Workerを登録（/rename-images/sw.js, scope=/rename-images/）。
    // scope がツールの全 locale ページ（/rename-images/, /rename-images/ja/ …）を被覆する。
    const registration = await navigator.serviceWorker.register('/rename-images/sw.js', {
      scope: '/rename-images/',
    });
