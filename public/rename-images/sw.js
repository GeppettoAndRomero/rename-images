...
const PRECACHE_URLS = [
  '/rename-images/',
  '/rename-images/manifest.json',
  '/rename-images/icon-192.png',
  '/rename-images/icon-512.png',
];
...
function isStaticAsset(pathname) {
  ...
  return staticExtensions.some(ext => pathname.endsWith(ext)) || pathname === '/rename-images/manifest.json';
}
